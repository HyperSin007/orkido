...
<div class="p-4 lg:p-6">
    <div class="max-w-4xl mx-auto">
        <h2 class="text-xl lg:text-2xl font-bold mb-6 text-center bg-white py-4 rounded shadow">Edit University</h2>
        <div class="bg-white shadow rounded p-4 lg:p-6">
            ...
            <div class="mt-6 lg:mt-8 flex flex-col lg:flex-row justify-center lg:justify-end gap-3 lg:gap-4">
                <a href="{{ route('universities.index') }}" class="py-3 lg:py-2 px-6 lg:px-4 rounded bg-gray-300 hover:bg-gray-400 text-gray-800 text-center font-medium transition-colors duration-200">Cancel</a>
                <button type="submit" class="py-3 lg:py-2 px-6 lg:px-4 rounded bg-green-600 hover:bg-green-700 text-white font-medium transition-colors duration-200">Update University</button>
            </div>
        </form>
    </div>
</div>
